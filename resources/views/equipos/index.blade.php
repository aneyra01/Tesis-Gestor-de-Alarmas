                                ...
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        <form action="{{ route('equipos.destroy', $equipo) }}" method="post">
                                            ...
                                            <a href="{{ route('equipos.edit', $equipo) }}" type="button" title="Editar"
                                                class="btn btn-outline-primary btn-sm"><i class="fas fa-pen"></i></a>

                                                <a href="{{ route('equipos.show', $equipo) }}" type="button" title=""
                                                class="btn btn-outline-primary btn-sm">Servicios</a>

                                            <button type="button" class="btn btn-outline-danger btn-sm" title="Borrar"
                                                data-toggle="modal" data-target="#modal1{{ $equipo->id }}">
                                                <i class="fas fa-trash"></i>
                                            </button>

                                            <!-- Modal -->
                                            <div class="modal fade" id="modal1{{ $equipo->id }}" tabindex="-1"
...
@section('js')
    <script>
        ...
        boton.addEventListener('click', () => {
            window.location.href = "{{ route('equipos.create') }}";
        })
    </script>
